...
class FIRMPartitionFunction:
    ...
    def __init__(self, field_params: FIRMFieldParameters, path_params: PathIntegralParameters):
    ...
    def compute_partition_function_monte_carlo(self) -> PartitionFunctionResult:
        ...
        print("🎲 Computing FIRM partition function via Monte Carlo...")
        ...
        provenance = DerivationNode(
            node_id="FIRMPartitionFunction",
            mathematical_expression="Z = ∫ Dφ D𝒢 DD exp(-S_E[φ,𝒢,D]/ℏ)",
            justification="Complete path integral formulation of FIRM statistical field theory"
        )
...
if __name__ == "__main__":
    print("🎲 Testing FIRM Partition Function...")
    ...
    partition_func = FIRMPartitionFunction(field_params, path_params)

    # Compute via Monte Carlo
    result = partition_func.compute_partition_function_monte_carlo()

    print("\n" + "="*80)
    print("🎯 FIRM PARTITION FUNCTION RESULTS")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("✅ FIRM PARTITION FUNCTION: OPERATIONAL")
