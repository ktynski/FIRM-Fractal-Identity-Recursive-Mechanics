...
class PhotonBaryonCouplingDerivation:
    ...
    def derive_coupling_strength_evolution(self) -> Dict[str, Any]:
        ...
        derivation_steps.append("Step 1: FIRM Coupling Formula")
        derivation_steps.append("Classical: coupling ∝ n_e σ_T (electron density × Thomson cross-section)")
        derivation_steps.append("FIRM: coupling ∝ C_j × φ^j (coherence × shell expansion factor)")
    ...
    def derive_photon_baryon_coupling(self) -> PhotonBaryonCouplingResult:
        """
        Complete derivation of photon-baryon coupling in FIRM.
        ...
        derivation_steps.append("Photon-Baryon Coupling: Complete FIRM Derivation")
        derivation_steps.append("=================================================")
        ...
        derivation_steps.append("\nStep 5: FIRM vs Classical Comparison")
        ...
        derivation_steps.append("FIRM: coupling ∝ C_j × φ^j (purely from shell coherence)")
        derivation_steps.append("Both predict decoupling at z ≈ 1100, but FIRM derives this from φ")
        ...
        falsification_criterion = (
            f"FIRM coupling theory fails if: (1) decoupling doesn't occur at j ≈ {decoupling_result['decoupling_shell']} ± 1, "
...
def main():
    ...
    print("FIRM Photon-Baryon Coupling: Coherent Shell Entanglement")
    print("=" * 65)
