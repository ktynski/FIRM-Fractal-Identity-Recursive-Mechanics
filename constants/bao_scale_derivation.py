...
class BAOScaleDerivation:
    ...
    def derive_bao_scale_formula(self, method: EchoMethod = EchoMethod.COMBINED_METHOD) -> Dict[str, Any]:
        """
        Derive complete BAO scale formula from FIRM morphic echo closure.
        ...
        derivation_steps.append("FIRM BAO Scale Derivation")
        derivation_steps.append("==========================")
        ...
        derivation_steps.append(f"\nStep 5: Observational comparison")
        derivation_steps.append(f"r_BAO FIRM = {final_bao_scale:.0f} Mpc")
...
def main():
    ...
    print("FIRM BAO Scale: Morphic Echo Closure Standard Ruler")
    print("="*60)
    ...
    print(f"\nFinal Result:")
    print(f"r_BAO FIRM = {result.theoretical_value:.0f} Mpc")
