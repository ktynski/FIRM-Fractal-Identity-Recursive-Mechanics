...
#!/usr/bin/env python3
"""
CMB TE and EE Polarization Spectra Derivation in FIRM
...
class CMBPolarizationSpectraDerivation:
    ...
    def derive_gradient_asymmetry(self) -> Dict[str, Any]:
        ...
        derivation_steps.append("In FIRM: ∇T || ∇P when shell curvatures align")
    ...
    def derive_polarization_spectra(self) -> PolarizationSpectraResult:
        ...
        derivation_steps.append("CMB Polarization Spectra: Complete FIRM Derivation")
        derivation_steps.append("==================================================")
        ...
        falsification_criterion = (
            f"FIRM predictions fail if: (1) TE anti-correlation dip is not at ℓ ≈ {dip_details['location']} ± 20, "
...
def main():
    ...
    print("FIRM CMB Polarization Spectra: φ-Shell Intersections")
    print("=" * 60)
